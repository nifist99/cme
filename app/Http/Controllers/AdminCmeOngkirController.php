<?php namespace App\Http\Controllers;
	...
	class AdminCmeOngkirController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "cme_ongkir";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Request by","name"=>"id_cms_users","join"=>"cms_users,name"];
			$this->col[] = ["label"=>"Cme Request","name"=>"id_cme_request","join"=>"cme_request,id"];
			$this->col[] = ["label"=>"Kendaraan","name"=>"kendaraan"];
			...
			$this->form[] = ['label'=>'Jeni Kendaraan','name'=>'kendaraan','type'=>'text','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Harga Ongkir','name'=>'harga','type'=>'money','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Kendaraan","name"=>"kendaraan","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
