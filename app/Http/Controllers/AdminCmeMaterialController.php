<?php namespace App\Http\Controllers;
	...
	class AdminCmeMaterialController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Harga Total","name"=>"harga_total"];
			...
			$this->form[] = ['label'=>'Harga Total','name'=>'harga_total','type'=>'money','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Cme Request','name'=>'id_cme_request','type'=>'select2','validation'=>'required','width'=>'col-sm-9','datatable'=>'cme_request,id'];
			$this->form[] = ['label'=>'remark','name'=>'remark','type'=>'textarea','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Material','name'=>'material','type'=>'textarea','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Harga','name'=>'harga','type'=>'money','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Satuan','name'=>'satuan','type'=>'text','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
