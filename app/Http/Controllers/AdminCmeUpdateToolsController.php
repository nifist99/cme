<?php namespace App\Http\Controllers;
	...
	class AdminCmeUpdateToolsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'List Tools Bulanan','name'=>'id_list_tools_bulanan','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'list_tools_bulanan,id'];
			...
			$this->form[] = ['label'=>'Nama Tabel','name'=>'nama_tabel','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Blade View','name'=>'blade_view','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"List Tools Bulanan","name"=>"id_list_tools_bulanan","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"list_tools_bulanan,id"];
			...
			//$this->form[] = ["label"=>"Nama Tabel","name"=>"nama_tabel","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			...
			//$this->form[] = ["label"=>"Blade View","name"=>"blade_view","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
