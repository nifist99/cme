<?php namespace App\Http\Controllers;
	...
	class AdminCmeDashboardWaspangController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		public function getIndex() {
			//First, Add an auth
			 ...
			 $data['material_approve']=DB::table('cme_material')
			 ...
			 ->sum('cme_material.harga_total');

			 $data['material_waiting']=DB::table('cme_material')
			 ->join('cme_request','cme_material.id_cme_request','cme_request.id')
			 ->where('cme_material.id_cms_users',CRUDBooster::myId())
			 ->where('cme_request.status','!=','approve')
			 ->sum('cme_material.harga_total');
             ...
             foreach(CRUDBooster::bulan() as $key){
				$nilai_m .=DB::table('cme_material')
					 ->join('cme_request','cme_material.id_cme_request','cme_request.id')
					 ->whereMonth('cme_material.created_at', $key['id'])
					 ->whereYear('cme_material.created_at',$data['tahun'])
					 ->where('cme_material.id_cms_users',CRUDBooster::myId())
					 ->where('cme_request.status','approve')
					 ->sum('cme_material.harga_total').",";
				...
				foreach(CRUDBooster::bulan() as $val){
					$nilai_o .=DB::table('cme_ongkir')
						 ->join('cme_request','cme_ongkir.id_cme_request','cme_request.id')
						 ->whereMonth('cme_ongkir.created_at', $val['id'])
						 ->whereYear('cme_ongkir.created_at',$data['tahun'])
						 ->where('cme_ongkir.id_cms_users',CRUDBooster::myId())
						 ->where('cme_request.status','approve')
						 ->sum('cme_ongkir.harga').",";
