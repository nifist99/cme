<?php namespace App\Http\Controllers;
	...
	class AdminCmeListToolsAdminController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Karyawan","name"=>"id_cms_users","join"=>"cms_users,name"];
	        ...
	        */
			...
			$this->addaction[]=['label'=>'Lihat Foto Tools Yang Di Isi Team','color'=>'success','icon'=>'fa fa-image',
	    ...
	    */
		...
		public function getApprove($id){
	    	...
	    	$status['penyetuju']=CRUDBooster::myId();

	    	$cek=DB::table('cme_list_tools')->where('id',$id)->update($status);
