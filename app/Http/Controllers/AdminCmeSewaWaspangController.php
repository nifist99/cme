<?php namespace App\Http\Controllers;
	...
	class AdminCmeSewaWaspangController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Alat','name'=>'alat','type'=>'text','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Alat","name"=>"alat","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
