<?php namespace App\Http\Controllers;
	...
	class AdminCmeProgresSiteController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Remark Kerjaan","name"=>"remark"];
			$this->col[] = ["label"=>"Tanggal","name"=>"tanggal"];
			$this->col[] = ["label"=>"Foto Activitas","name"=>"foto","image"=>true];
